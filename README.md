...
8/18/2025: Switched to class version of get_data() by chatgpt. ✅ bug: start_date and end_date are the same per symbol, but should be dependent on symbol data. Create get() for reading saved stats_df.  create histogram function(symbols_df, returns_df, stats_df), create timeline of relative gains
